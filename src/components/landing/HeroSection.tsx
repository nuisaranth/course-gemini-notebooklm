...
const details = [
  { icon: CalendarDays, label: "รุ่น 5", value: "7 มิ.ย. 69", color: "text-google-blue" },
      ...
      <div className="container relative mx-auto px-4 py-10 md:py-16">
        <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          <div className="mb-6 inline-flex items-center gap-1.5 rounded-full bg-primary-foreground/15 px-4 py-1.5 text-xs font-semibold backdrop-blur-sm sm:gap-2 sm:px-5 sm:py-2 sm:text-sm">
            ...
            เปิดรับสมัครรุ่นที่ 5 แล้ว! (รับจำกัดเพียง 10 ที่นั่งเท่านั้น)
          </div>
          ...
          <p className="mt-6 text-sm text-primary-foreground/60">
            ราคาเพียง <span className="text-2xl font-extrabold text-google-yellow">฿3,900</span> / ท่าน (รวม VAT)
          </p>
        </div>
      </div>
    </section>
