...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "ผู้เข้าอบรมทุกท่านจะได้รับสิทธิ์เข้า 'กลุ่มลับ LINE ตลอดชีพ' ซึ่งสามารถเข้ามาอัปเดตฟีเจอร์ AI ใหม่ๆ และสอบถามปัญหาการใช้งานจริงกับ อ.ชีพธรรม และ อ.พันธุ์ทิตต์ ได้ตลอดเวลา",
  },
  {
    question: "สามารถออกใบกำกับภาษีในนามบริษัทได้หรือไม่?",
    answer:
      "สามารถออกใบกำกับภาษีเต็มรูปแบบได้ ราคา 3,900 บาท เป็นราคาที่รวม VAT เรียบร้อยแล้ว สามารถแจ้งชื่อ-ที่อยู่บริษัทกับแอดมินตอนทัก LINE สมัครอบรมได้เลย",
  },
  {
