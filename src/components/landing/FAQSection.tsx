...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "สิ่งที่ต้องเตรียมมีเพียง 2 อย่าง คือ\n• คอมพิวเตอร์โน้ตบุ๊ก พร้อมสายชาร์จ\n• บัญชี Google (Gmail) เพื่อใช้ล็อกอินเข้าสู่ระบบ",
  },
  {
    question: "จำเป็นต้องเสียเงินสมัคร Gemini Advanced เพิ่มไหม?",
    answer:
      "เนื้อหาหลักสามารถใช้เวอร์ชันฟรีเรียนได้ แต่สำหรับฟีเจอร์ขั้นสูงอย่าง Deep Research และ Gems แนะนำให้ใช้เวอร์ชัน Advanced ซึ่งผู้เรียนสามารถกดรับสิทธิ์ 'ทดลองใช้ฟรี 1 เดือน' ในวันอบรมได้เลย (ยังไม่ต้องเสียเงิน)",
  },
  {
    question: "หลังเรียนจบแล้ว หากติดปัญหา มีที่ปรึกษาไหม?",
    answer:
      "มี! ผู้เข้าอบรมทุกท่านจะได้รับสิทธิ์เข้า 'กลุ่มลับ LINE ตลอดชีพ' ซึ่งสามารถเข้ามาอัปเดตฟีเจอร์ AI ใหม่ๆ และสอบถามปัญหาการใช้งานจริงกับ อ.ชีพธรรม และทีมงานได้ตลอดเวลา",
  },
  {
  ...
  },
  {
    ...
    answer:
      "อบรมที่ ร้านกาแฟพันธุ์ไทย (ซอยลาดพร้าว 130)\n🚇 ใกล้ MRT: สายสีเหลือง (สถานีลาดพร้าว 101)\n🚗 รถยนต์: มีที่จอดรถฟรีให้บริการ",
  },
];
