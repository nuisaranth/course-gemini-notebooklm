...
const faqs = [
  ...
  {
    question: "จำเป็นต้องเสียเงินสมัคร Gemini Pro เพิ่มไหม?",
    answer:
      "เนื้อหาหลักสามารถใช้เวอร์ชันฟรีเรียนได้ แต่สำหรับฟีเจอร์ขั้นสูงอย่าง Deep Research และ Gems แนะนำให้ใช้เวอร์ชัน Pro ซึ่งผู้เรียนสามารถกดรับสิทธิ์ 'ทดลองใช้ฟรี 1 เดือน' ในวันอบรมได้เลย (ยังไม่ต้องเสียเงิน)",
  },
  {
