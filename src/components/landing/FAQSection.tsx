...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "ไม่จำเป็น! ปัจจุบันบัญชี Google แบบฟรี สามารถใช้งานฟีเจอร์ขั้นสูงอย่าง Deep Research และ Gems ได้แล้ว ผู้เข้าอบรมสามารถใช้บัญชีฟรีเรียนและทำเวิร์กชอปได้ครบทุกเนื้อหา โดยไม่ต้องเสียเงินอัปเกรดแพ็กเกจใดๆ",
  },
  {
